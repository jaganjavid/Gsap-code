...
// Instantiate a new Slider object, passing 
// the DOM element with the .slider class as the target
const slider = new Slider(document.querySelector('.slider'));

const initializeSlider = () => {
	// Define the navigate function to call the appropriate 
    // Slider method based on the action parameter (next or prev)
	const navigate = action => slider[action](); 

	// Add click event listeners to the navigation controls, calling 
    // the navigate function with the appropriate action
