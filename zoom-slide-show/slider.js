...
export class Slider {
	...
	// Method to navigate the slider in the 
    // given direction (1 for next, 0 for previous)
	navigate(direction) {
		...
		// Define variables to reference the current, next,
        //  previous, and slide before previous slide
